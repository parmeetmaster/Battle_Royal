...
public class IdPassT1Activity extends AppCompatActivity {

    TextView option_2, option_3, option_4;

    ActivityIdPassT1Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityIdPassT1Binding.inflate(getLayoutInflater());
...
//                mInterstitialAd.show(IdPassT1Activity.this);
//            }
//
//            @Override
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(IdPassT1Activity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
