...
public class MatchJoinedT2PlayersActivity extends AppCompatActivity {

    FirebaseFirestore database;
    User user;
    CrewModel crewModel;
    ActivityMatchJoinedT2PlayersBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMatchJoinedT2PlayersBinding.inflate(getLayoutInflater());
