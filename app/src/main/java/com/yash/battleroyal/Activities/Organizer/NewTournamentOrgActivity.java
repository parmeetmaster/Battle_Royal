...
import com.yash.battleroyal.databinding.ActivityNewResultOrgBinding;
...
public class NewTournamentOrgActivity extends AppCompatActivity {

   ActivityNewTournamentOrgBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNewTournamentOrgBinding.inflate(getLayoutInflater());
        ...
        binding.joinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String uid = FirebaseAuth.getInstance().getUid();
                progressDialog.setMessage("Uploding Tournament");
                progressDialog.show();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                file.put("tournamentImage", imageUri.toString());
                                file.put("tournamentName", slot);//
                                database.collection("organizer").document(uid)
                                        .collection(tier)
                                        .document(slot)
                                        .set(file)
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                database
                                                        ...
                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            @Override
                                                            public void onSuccess(Void unused) {
                                                                Toast.makeText(NewTournamentOrgActivity.this, "Added Successful", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                            }
                                        });
