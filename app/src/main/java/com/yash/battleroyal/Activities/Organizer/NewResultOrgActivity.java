...
public class NewResultOrgActivity extends AppCompatActivity {

    ActivityNewResultOrgBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNewResultOrgBinding.inflate(getLayoutInflater());
        ...
        binding.joinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String uid = FirebaseAuth.getInstance().getUid();
                progressDialog.setMessage("Uploding result");
                progressDialog.show();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                file.put("resultImage", imageUri.toString());
                                file.put("resultName", slot);//
                                database.collection(tier).document(matchId)
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                Toast.makeText(NewResultOrgActivity.this, "Added Successful", Toast.LENGTH_SHORT).show();
                                            }
                                        });
