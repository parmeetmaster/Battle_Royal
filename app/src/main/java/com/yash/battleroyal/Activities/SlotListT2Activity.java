...
public class SlotListT2Activity extends AppCompatActivity {

    ActivitySlotListT2Binding binding;
    FirebaseFirestore database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySlotListT2Binding.inflate(getLayoutInflater());
...
//                mInterstitialAd.show(SlotListT2Activity.this);
//            }
//
//            @Override
