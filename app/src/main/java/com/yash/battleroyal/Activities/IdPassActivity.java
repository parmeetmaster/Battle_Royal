...
public class IdPassActivity extends AppCompatActivity {


    TextView option_2, option_3, option_4;

    ActivityIdPassBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityIdPassBinding.inflate(getLayoutInflater());
...
//                mInterstitialAd.show(IdPassActivity.this);
//            }
//
//            @Override
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(IdPassActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
