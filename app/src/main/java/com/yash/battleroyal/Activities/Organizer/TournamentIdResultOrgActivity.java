...
import com.yash.battleroyal.databinding.ActivityTournamentIdResultOrgBinding;
...
public class TournamentIdResultOrgActivity extends AppCompatActivity {

    ActivityTournamentIdResultOrgBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTournamentIdResultOrgBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
            ...
            ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,getResources()
                    .getStringArray(R.array.tournamentList));
            myAdapter.setDropDownViewResource(android.R.layout.simple_list_item_1);
            binding.tierSpinner.setAdapter(myAdapter);

            ArrayAdapter<String> myAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,getResources()
                    .getStringArray(R.array.typeList));
            myAdapter.setDropDownViewResource(android.R.layout.simple_list_item_1);
            binding.typeSpinner.setAdapter(myAdapter1);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    file.put(type+"Image", imageUri.toString());
                                    file.put(type+"Name", slot);//
                                    database.collection(tier).document(tournamentId)
                                            .collection(type)
                                            .document(uid)
                                            .set(file)
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    ...
                                                    Toast.makeText(TournamentIdResultOrgActivity.this, "Added Successful", Toast.LENGTH_SHORT).show();
                                                }
                                            });
