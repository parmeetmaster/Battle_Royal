...
public class ContestAdapter extends RecyclerView.Adapter<ContestAdapter.ContestViewHolder> {
    ...
    public ContestAdapter(Context context, ArrayList<ContestModel> contestModels) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ContestAdapter.ContestViewHolder holder, int position) {
        final  ContestModel model = contestModels.get(position);

        String gameId = ((ContestDetailsActivity) context).getIntent().getStringExtra("gameId");
        ...
        holder.joinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String gameId = ((ContestDetailsActivity) context).getIntent().getStringExtra("gameId");
                Intent intent = new Intent(context, ContestRegisterActivity.class);
