...
public class GameNameOrgAdapter extends RecyclerView.Adapter<GameNameOrgAdapter.GameViewHolder> {

    Context context;
    ArrayList<GameNameModel> gameNameModels;

    public GameNameOrgAdapter(Context context, ArrayList<GameNameModel> gameNameModels){
    ...
    public void onBindViewHolder(@NonNull GameViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, NewPaidContestOrgActivity.class);
